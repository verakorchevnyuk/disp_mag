function [ lm, R, Bgrad, Gamma ] = beam_dynamics_variables( beta, Bref, Bgrad, T0, T1, T2, plot_info )
% IN:
...
[ theta1, P1, ~, ~, ~, lm1, R1 ] = particle_trajectory_until_exiting_magnet_with_bend_radius( m, b, T1, rref, Bref, Bgrad, p, v, resol, gapMin, NI ) ;
...
[ theta2, P2, ~, ~, ~, lm2, R2 ] = particle_trajectory_until_exiting_magnet_with_bend_radius( m, b, T2, rref, Bref, Bgrad, p, v, resol, gapMin, NI ) ;
